...
import 'package:wallpaper_app/pages/login.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  _handleSignUpWithEmail() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      await sb.signUpWithEmail(_nameCtlr.text ,_emailCtlr.text.trim(), _passCtlr.text).then((_) {
        if (sb.hasError == true) {
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text('Create Account', style: Theme.of(context).textTheme.headlineSmall?.copyWith(
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      suffixIcon:
                          IconButton(icon: const Icon(Icons.close), onPressed: _nameCtlr.clear)),
                ),
              ),
              const SizedBox(
                height: 20,
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(5)),
                      suffixIcon:
                          IconButton(icon: const Icon(Icons.close), onPressed: _emailCtlr.clear)),
                ),
              ),
              const SizedBox(
                height: 20,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                        ...
                        onPressed: ()=> nextScreenReplace(context, const LoginPage())),
                  ],
                ),
              ),
              const SizedBox(
